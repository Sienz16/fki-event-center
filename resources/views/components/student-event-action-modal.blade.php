<div x-show="actionModalOpen" 
     ...
     {{-- x-init="$watch('actionModalOpen', value => {
         if (value) {
    ...
    <div class="relative w-full max-w-lg mx-auto bg-white shadow-lg rounded-3xl"
        ...
        <div class="px-6 pt-8 pb-6 text-center">
            <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full {{ $iconBg }} mb-6">
                {{ $icon }}
            </div>
            ...
            <div class="flex justify-center space-x-4">
                ...
                <button @click="actionModalOpen = false" 
                        class="inline-flex justify-center items-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-{{ $color }}-500 transition-colors duration-200 w-32">
                    Cancel
                </button>
            </div>
        </div>
