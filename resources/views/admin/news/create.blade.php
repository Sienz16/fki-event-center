...
<div class="min-h-full">
    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Create News</h1>
        </div>
    </header>
        ...
        <div class="mx-auto max-w-7xl px-2 py-6 sm:px-4 lg:px-6">
            <div class="border border-gray-300 p-4 sm:p-8 bg-white shadow-lg rounded-xl">
                ...
                <div class="mb-10 text-center">
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Create New News</h2>
                    <p class="text-gray-600">Fill in the details below to create your news article</p>
                </div>
                ...
                <form action="{{ route('admin.news.store') }}" method="POST" class="max-w-4xl mx-auto space-y-8">
                    @csrf
                    <input type="hidden" name="management_id" value="{{ auth()->user()->admin->management_id }}">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="news_details" id="news_details" rows="6" required
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm">{{ old('news_details') }}</textarea>
                    </div>
