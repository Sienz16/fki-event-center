<div x-show="deleteModalOpen" 
    ...
    <div class="relative w-full max-w-lg mx-auto bg-white shadow-lg rounded-3xl"
        ...
        <button @click="deleteModalOpen = false" class="absolute top-4 right-4 text-gray-400 hover:text-gray-500">
        ...
        <div class="px-6 pt-8 pb-6 text-center">
            ...
            <h3 class="text-2xl font-bold text-gray-900 mb-4">Delete {{ $title }}</h3>
